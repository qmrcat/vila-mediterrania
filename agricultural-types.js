import {PERSONAL_TERRAINS,assertNoKeyCollisions} from './personal-content.js';

/** Shared agricultural terrain definitions, independent of the renderer. */
const CORE_AGRICULTURAL_TERRAINS={
...
assertNoKeyCollisions(CORE_AGRICULTURAL_TERRAINS,PERSONAL_TERRAINS,'PERSONAL_TERRAINS');
const reservedTerrainId=Object.keys(PERSONAL_TERRAINS).find(id=>['land','meadow','rocky','beach','house','plaza','stairs','cobble','dirt','asphalt'].includes(id));
if(reservedTerrainId)throw new Error(`mods-personals: el terreny «${reservedTerrainId}» repeteix un tipus bàsic del joc.`);
export const AGRICULTURAL_TERRAINS={...CORE_AGRICULTURAL_TERRAINS,...PERSONAL_TERRAINS};
