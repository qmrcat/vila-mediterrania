...
export const CONFIG = {
  ...
  geometry: {
    cylinderSegments: 32,  // Cares dels cilindres: enter de 3 a 256. Més cares, més detall.
  },
  houses: {
...
integer(CONFIG.geometry.cylinderSegments,3,'geometry.cylinderSegments (3–256)');
if(CONFIG.geometry.cylinderSegments>256)invalid('geometry.cylinderSegments (3–256)');
