...
export const SIGNED_LANDMARKS=['hospital','school','police','fireStation','recycling','cemetery','hotel3','hotel5','hostal','pension','museum','monastery','parliament','institution','barracksSenyera','barracksEstelada'];
